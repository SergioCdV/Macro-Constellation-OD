...
function [PropPrior, sigma_points] = PropagationStep(obj, last_epoch, new_epoch, TargetEstimator, Prior)
    ...
    for i = 1:size(particles,2)
        ...
        TargetEstimator = TargetEstimator.InitConditions(mu, Sigma);
