...
while ( ischar(line1) )
    ...
    elseif (curobj > 0)
        ...
        RV = Astrodynamics.ECI2COE(meanElements, false);                            % Cartesian elements
        ...
        hm(:,cnt) = s(end,1:3).' * (L^2/T);             % This shall be replaced by the Milankovitch propagation and osculating transformation
        em(:,cnt) = s(end,4:6).';                       % This shall be replaced by the Milankovitch propagation and osculating transformation
