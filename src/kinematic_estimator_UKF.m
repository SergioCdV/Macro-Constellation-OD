...
%         - class Mixture, containing the definition of the Gaussian
%           Mixture model
%         - class Estimator, with the core estimator to be used within the
%           problem

% Outputs:  - 

% Bayesian estimation based on EKF-PHD
function [L, f, N, X] = kinematic_estimator_UKF(t, observations, Mixture, Estimator)
    % Constants 
